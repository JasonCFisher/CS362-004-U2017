...
int getCost(int cardNumber)
{
  ...
  //altered card functions

  //altered Adventurer card
...
//Altered Village card
void alteredVillage(struct gameState *state, int handPos){
...
//Altered minion card 
void alteredMinion(struct gameState *state, int handPos, int choice1, int choice2){
...
//Altered Great Hall card
void alteredGreatHall(struct gameState *state, int handPos){
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
    	alteredAdventurer(state, handPos);
    	return 0;
    ...
    case great_hall:
    	...
    	alteredGreatHall(state, handPos);
    ...
    case minion:
    	...
    	alteredMinion(state, handPos, choice1, choice2);
